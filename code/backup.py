...
for variable, corr_list in grouped_correlations.items():
    ...
    for col2, corr, p_value in sorted_corr_list:
        ...
        print(f"  {col2}: correlation = {corr:.4f}, p-value = {p_value:.4f} {significance}")
...
for variable, influence in sorted_influence:
    print(f"{variable}: total influence = {influence:.4f}, normalized influence = {normalized_influence[variable]:.4f}")
